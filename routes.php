...
Route::get('/', function(){ echo 'function closure is working'; });
...
// Route::get('/encrypt', function(){ ContainerResolver::get('CryptoController', 'AsymetriceEncryptMessage');});
// Route::get('/decrypt', function(){ ContainerResolver::get('CryptoController', 'AsymetriceDecryptMessage');});
